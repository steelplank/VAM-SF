...
{
    // TODO: Clean up unnecessary properties when the time comes
    // OsuBeatmap and OsuCatchBeatmap should not share a parent/interface, I want to treat osu! and osu!catch as completely different games
    public class OsuCatchBeatmap
    {
        ...
        // [HitObjects] Section
        public List<OsuCatchHitObject> HitObjects { get; set; } = [];
    }
}
